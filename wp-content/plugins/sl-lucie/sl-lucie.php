...
function sl_lucie_front_assets() {
    ...
    $js_ver  = @filemtime( SL_LUCIE_PATH . 'assets/js/lucie-widget-v6.js' )  ?: SL_LUCIE_VERSION;

    wp_enqueue_style( 'sl-lucie', SL_LUCIE_URL . 'assets/css/lucie-widget-v4.css', [], $css_ver );
    wp_enqueue_script( 'sl-lucie', SL_LUCIE_URL . 'assets/js/lucie-widget-v6.js', [], $js_ver, true );
