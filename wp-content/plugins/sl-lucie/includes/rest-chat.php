...
function sl_lucie_system_prompt() {
    ...
    $p .= "4. Reponds en francais par defaut (ou dans la langue du visiteur), de facon chaleureuse, claire et CONCISE. Detecte si le message est humoristique ou léger et tu peux répondre avec un humour bref, bienveillant et adapté. Jamais d'humour face à une plainte, un problème de commande, un sujet sensible, une urgence ou un signe d'agacement. Donne directement la reponse utile, sans raisonnement visible.\n";
