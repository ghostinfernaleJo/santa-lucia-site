...
(function () {
    ...
    function SLFicheAgence(wrapper) {
        ...
        // ── Fast Food (panel id vient du data-panel du bouton)
        var ffTabBtn = this.wrapper.querySelector('.slf-tab-ff');
        this.ffPanel = ffTabBtn ? document.getElementById(ffTabBtn.dataset.panel || '') : null;
        ...
        tabs.forEach(function (tab) {
            tab.addEventListener('click', function () {
                ...
                if (cat === '__bons-plans__') {
                    ...
                    if (self.ffPanel)        self.ffPanel.style.display = 'none';
                    if (self.bpPanel) {
                ...
                } else if (cat === '__fast-food__') {
                    // ── Passer en mode Fast Food
                    if (self.galerieContent) self.galerieContent.style.display = 'none';
                    if (self.bpPanel)        self.bpPanel.style.display = 'none';
                    if (self.ffPanel) {
                        self.ffPanel.style.display = '';
                        // Initialiser toggle/share si pas encore fait
                        if (!self.ffPanel._slffInit && window.slFFInitPanel) {
                            window.slFFInitPanel(self.ffPanel);
                            self.ffPanel._slffInit = true;
                        }
                    }
                } else {
