...
function sl_submit_cake_request() {
    ...
    $allowed_types = [ 'Anniversaire', 'Anniversaire surprise', 'Mariage', 'Baptême', 'Communion', 'Événement professionnel', 'Autre' ];
        ...
        <div class="sl-cake-layout">
            ...
            <div class="sl-cake-panel">
                ...
                <form data-sl-cake-auto>
                    ...
                    <label>Occasion *<select name="type" required><option value="">Choisir…</option><option>Anniversaire</option><option>Anniversaire surprise</option><option>Mariage</option><option>Baptême</option><option>Communion</option><option>Événement professionnel</option><option>Autre</option></select></label>
