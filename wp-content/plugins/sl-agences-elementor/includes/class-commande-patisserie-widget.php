...
function slg_append_cake_form_to_patisserie( $content ) {
    ...
    <style>
        ...
        @media(max-width:650px){.sl-cake-auto{margin:30px 14px;border-radius:20px}.sl-cake-visual,.sl-cake-visual-content{min-height:280px}.sl-cake-visual-content{padding:20px}.sl-cake-promise{padding:17px;border-radius:14px}.sl-cake-promise p{margin-bottom:12px;font-size:17px}.sl-cake-panel{padding:30px 20px}.sl-cake-auto form{grid-template-columns:1fr}.sl-cake-auto .full,.sl-cake-auto .result{grid-column:auto}.sl-cake-auto button{width:100%}}
    </style>
