...
function slg_append_cake_form_to_patisserie( $content ) {
    ...
    ob_start(); ?>
    <style>.sl-cake-auto{max-width:980px;margin:35px auto;padding:28px;border-radius:20px;background:#fff8fb;border:1px solid #f1dbe6}.sl-cake-auto h2{text-align:center;color:#142b4f;margin:0 0 8px}.sl-cake-auto>p{text-align:center;color:#5e6877}.sl-cake-auto form{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:14px}.sl-cake-auto label{display:flex;flex-direction:column;gap:6px;font-weight:600;color:#142b4f;font-size:14px}.sl-cake-auto input,.sl-cake-auto select,.sl-cake-auto textarea{box-sizing:border-box;width:100%;padding:11px;border:1px solid #d8dce4;border-radius:9px;background:#fff;font:inherit}.sl-cake-auto textarea{min-height:90px}.sl-cake-auto .full,.sl-cake-auto .result{grid-column:1/-1}.sl-cake-auto button{border:0;border-radius:9px;padding:13px 22px;background:#e91e63;color:#fff;font-weight:700;cursor:pointer}.sl-cake-auto button:disabled{opacity:.6}.sl-cake-auto .result{padding:12px;border-radius:9px;background:#eaf8f0;color:#17633a}.sl-cake-auto .hp{position:absolute;left:-9999px}@media(max-width:650px){.sl-cake-auto form{grid-template-columns:1fr}.sl-cake-auto .full,.sl-cake-auto .result{grid-column:auto}}
    </style>
