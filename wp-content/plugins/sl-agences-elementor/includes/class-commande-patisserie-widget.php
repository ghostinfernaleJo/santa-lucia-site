...
function slg_append_cake_form_to_patisserie( $content ) {
    ...
    ob_start(); ?>
    <style>.sl-cake-auto{max-width:1040px;margin:56px auto;padding:clamp(26px,5vw,58px);border-radius:28px;background:linear-gradient(135deg,#fff8fb 0%,#fff 62%);border:1px solid #f0d8e5;box-shadow:0 18px 50px rgba(20,43,79,.1)}.sl-cake-auto h2{text-align:center;color:#142b4f;margin:0 0 10px;font-size:clamp(27px,4vw,42px);letter-spacing:-.02em}.sl-cake-auto>p{text-align:center;color:#647083;max-width:650px;margin:0 auto 32px;line-height:1.6}.sl-cake-auto form{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:18px}.sl-cake-auto label{display:flex;flex-direction:column;gap:8px;font-weight:700;color:#142b4f;font-size:14px}.sl-cake-auto input,.sl-cake-auto select,.sl-cake-auto textarea{box-sizing:border-box;width:100%;padding:13px 14px;border:1px solid #d7dde7;border-radius:11px;background:#fff;font:inherit;color:#172033;transition:border-color .2s,box-shadow .2s}.sl-cake-auto input:focus,.sl-cake-auto select:focus,.sl-cake-auto textarea:focus{outline:0;border-color:#e91e63;box-shadow:0 0 0 3px rgba(233,30,99,.12)}.sl-cake-auto textarea{min-height:112px}.sl-cake-auto .full,.sl-cake-auto .result{grid-column:1/-1}.sl-cake-auto button{border:0;border-radius:11px;padding:15px 28px;background:#e91e63;color:#fff;font-weight:800;font-size:15px;cursor:pointer;box-shadow:0 8px 18px rgba(233,30,99,.2)}.sl-cake-auto button:disabled{opacity:.6}.sl-cake-auto .result{padding:14px 16px;border-radius:11px;background:#eaf8f0;color:#17633a}.sl-cake-auto .hp{position:absolute;left:-9999px}@media(max-width:650px){.sl-cake-auto{margin:34px 14px;padding:26px 18px;border-radius:20px}.sl-cake-auto form{grid-template-columns:1fr}.sl-cake-auto .full,.sl-cake-auto .result{grid-column:auto}.sl-cake-auto button{width:100%}}
    </style>
